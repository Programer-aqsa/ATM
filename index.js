...
async function startATMconversation() {
    ...
    const answers = await inquirer.prompt([
        ...
        },
        {
            ...
            when: (answers) => answers.accountType === "current",
        },
        {
            type: "list",
            name: "amount",
            ...
            when: (answers) => answers.transactionType === "Fastcash withdrawal",
        },
        {
            type: "number",
            name: "amount",
            message: "Enter your amount:",
            when: (answers) => answers.transactionType === "Normal withdrawal",
        },
    ]);
